    ...
    <div class="row">
        <div class="col-sm-6 col-md-3">
            <div class="lavalite-info-tile blue">
                <a href="{!!url(getenv('auth.guard').'/order/order')!!}">
                    <div class="tile-heading clearfix">
                        <span class="title">Orders</span>
                    </div>
                    <div class="tile-body clearfix">
                       <span class="text"><sup></sup>{!!Order::count(getenv('guard'))!!}</span>
                ...
                <div class="tile-footer clearfix">
                    <a href="{!!url(getenv('auth.guard').'/order/order')!!}"><span class="text-small">Go to orders</span></a>          
                </div>
            </div>
        </div>
        <div class="col-sm-6 col-md-3">
            <div class="lavalite-info-tile green">
                <a href="{!!url(getenv('auth.guard').'/returns/returns')!!}">
                    <div class="tile-heading clearfix">
                        <span class="title">Returns</span>
                    </div>
                    <div class="tile-body clearfix">
                        <span class="text"><sup></sup>{!!@Returns::count('web')!!}</span>
