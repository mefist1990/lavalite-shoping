...
class RouteServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $namespace = 'Laracart\Attribute\Http\Controllers';
    ...
    public function boot()
    {
        ...
        if (Request::is('*/attribute/attribute/*')) {
            Route::bind('attribute', function ($attribute) {
                $attributerepo = $this->app->make('\Laracart\Attribute\Interfaces\AttributeRepositoryInterface');
                return $attributerepo->findorNew($attribute);
            });
        }
if (Request::is('*/attribute/attribute_group/*')) {
            Route::bind('attribute_group', function ($attribute_group) {
                $attribute_grouprepo = $this->app->make('\Laracart\Attribute\Interfaces\AttributeGroupRepositoryInterface');
