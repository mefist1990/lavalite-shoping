            ...
            <div class="card">
                <div class="header with-sub" data-background-color="red">
                    <div class="row">
                        <div class="col-sm-11 title-main">
                            ...
                            <h4 class="title">{{ trans('app.create')  }} coupon</h4>
                            <p class="sub-title">{{ trans('app.add')  }} coupon here...</p>
                        </div>
                        <div class="col-sm-1">
                ...
                <div class="footer">
                    <button class="btn-primary btn-raised btn btn-sm">{{ trans('app.create')  }} News</button>
                     <a href="{{ trans_url(get_guard('url').'/coupon/coupon') }}" class="btn-danger btn-raised btn btn-sm"> {{ trans('app.back')  }}</a>
                </div>
                {!! Form::close() !!}
            </div>
        </div>
