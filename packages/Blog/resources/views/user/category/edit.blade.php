    ...
    <div class="row">
        <div class="col-xs-12">
            <div class="card">
                ...
                ->action(trans_url(get_guard('url').'/blog/category') .'/'.$category->getRouteKey())!!}
                ...
                <div class="footer">
                    ...
                    <a href="{{ trans_url(get_guard('url').'/blog/category') }}" class="btn-danger btn-raised btn btn-sm" >Cancel</a>
                </div>
                {!! Form::close() !!}
            </div>
        </div>
