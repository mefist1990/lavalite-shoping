    <div class="nav-tabs-custom">
        ...
        <ul class="nav nav-tabs primary">
            ...
            <div class="box-tools pull-right">
                ...
                <button type="button" class="btn btn-default btn-sm" data-action='CLOSE' data-load-to='#blog-category-entry' data-href='{{trans_url('admin/blog/category/0')}}'><i class="fa fa-times-circle"></i> {{ trans('app.close') }}</button>
            </div>
        </ul>
