    <div class="nav-tabs-custom">
        ...
        <ul class="nav nav-tabs primary">
            ...
            <div class="box-tools pull-right">
                ...
                <button type="button" class="btn btn-default btn-sm" data-action='CANCEL' data-load-to='#blog-category-entry' data-href='{{trans_url('admin/blog/category')}}/{{$category->getRouteKey()}}'><i class="fa fa-times-circle"></i> {{ trans('app.cancel') }}</button>
        ...
        ->action(URL::to('admin/blog/category/'. $category->getRouteKey()))!!}
