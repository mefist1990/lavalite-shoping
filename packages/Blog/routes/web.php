...
Route::group(['prefix' => '/admin/blog'], function () {
    Route::put('news/workflow/{blog}/{step}', 'BlogAdminController@putWorkflow');
...
Route::group(['prefix' => '/blogs'], function () {
    Route::get('news/workflow/{blog}/{step}/{user}', 'BlogController@getWorkflow');
...
Route::group(['prefix' => '/blog'], function () {
    Route::get('category/workflow/{category}/{step}/{user}', 'CategoryController@getWorkflow');
    Route::get('category/', 'CategoryPublicController@index');
