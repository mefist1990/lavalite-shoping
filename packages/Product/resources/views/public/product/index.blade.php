                 ...
                 @if(Session::has('success'))
                    ...
                    <div class="col-md-4 sidebar">
                        ...
                        <div class="widget">
                            ...
                            <div class="row">
                                <div class="col-xs-6">
                                    <input type="number" name="search[price][min]" id="price-min" value="{{Request::input('search.price.min')}}" class="form-control chosen-select" required="required" placeholder="Min" />
                                        
                                </div>
                                <div class="col-xs-6">
                                    <input type="number" name="search[price][max]" id="price-max" value="{{Request::input('search.price.max')}}" class="form-control chosen-select" required="required" placeholder="Max"/>
