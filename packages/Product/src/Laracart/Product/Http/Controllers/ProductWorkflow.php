...
use Litepie\Product\Http\Requests\ProductRequest;
use Litepie\Product\Models\Product;
    ...
    public function putWorkflow(ProductRequest $request, Product $product, $step)
    {
        ...
        try {
            ...
            return response()->json([
                'message'  => trans('messages.success.changed', ['Module' => trans('product::product.name'), 'status' => trans("app.{$step}")]),
                'code'     => 204,
    ...
    */
    ...
    public function getWorkflow(Product $product, $step, $user)
    {
        try {
            ...
            return $this->theme->layout('blank')->of('product::admin.product.message', $data)->render();
