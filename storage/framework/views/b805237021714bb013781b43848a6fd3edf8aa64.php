    ...
    <div class="row">
        <div class="col-sm-6 col-md-3">
            <div class="lavalite-info-tile blue">
                <a href="<?php echo url(getenv('auth.guard').'/order/order'); ?>">
                    <div class="tile-heading clearfix">
                        <span class="title">Orders</span>
                    </div>
                    <div class="tile-body clearfix">
                       <span class="text"><sup></sup><?php echo Order::count(getenv('guard')); ?></span>
                       <span class="icon"><i class="pe-7s-menu"></i></span>
                    </div>
                </a>
                <hr>
                  
                <div class="tile-footer clearfix">
                    <a href="<?php echo url(getenv('auth.guard').'/order/order'); ?>"><span class="text-small">Go to orders</span></a>          
                </div>
            </div>
        </div>
        <div class="col-sm-6 col-md-3">
            <div class="lavalite-info-tile green">
                <a href="<?php echo url(getenv('auth.guard').'/returns/returns'); ?>">
                    <div class="tile-heading clearfix">
                        <span class="title">Returns</span>
                    </div>
                    <div class="tile-body clearfix">
                        <span class="text"><sup></sup><?php echo @Returns::count('web'); ?></span>
                      <span class="icon"><i class="pe-7s-back"></i></span>
                    </div>                
                    <hr>
                    <div class="tile-footer clearfix">
                         <span class="text-small">Go to returns</span>
                    </div>
                </a>
            </div>
        </div>       
        <div class="col-sm-6 col-md-3">
            <div class="lavalite-info-tile red">
                <a href="<?php echo url(getenv('auth.guard').'/task/task'); ?>">
                    <div class="tile-heading clearfix">
                        <span class="title">Task</span>
                    </div>
                    <div class="tile-body clearfix">
                        <span class="text"><sup></sup><?php echo Task::count(getenv('guard')); ?></span>
        ...
        <div class="col-sm-6 col-md-3">
            <div class="lavalite-info-tile purple">
                <a href="<?php echo url(getenv('auth.guard').'/calendar/calendar'); ?>">
                    <div class="tile-heading clearfix">
                        <span class="title">Events</span>
                    </div>
                    <div class="tile-body clearfix">
                        <span class="text"><sup></sup><?php echo Calendar::count(getenv('guard')); ?></span>
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="panel">
                <div class="body card card-calendar mn pn">
                    <?php echo Calendar::gadget('user.calendar.gadget'); ?>

                </div>
            </div>
        </div>
        <div class="col-md-4">
            <!-- <?php echo Task::userGadget(); ?> -->
        ...
        <div class="col-md-4">
            <div class="panel panel-default alt with-footer">
                ...
                <div class="footer">
                    <a href="<?php echo url(getenv('auth.guard').'/task/task'); ?>" class="btn btn-success btn-raised btn-sm">Add New</a>
                </div>
            </div>
        </div>
    </div>     
